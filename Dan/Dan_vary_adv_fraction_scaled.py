...
if __name__ == '__main__':
    ...
    ax2.set_xticklabels(ax2_labels, fontweight='bold', fontsize=11)#, rotation = 20)
    ax2.set_xlabel('Transactions Captured (%)', fontsize='x-large', fontweight='bold')
    ax.set_xlabel('Colluding Nodes (%)', fontsize='x-large', fontweight='bold')
    ax.set_ylabel('Entropy', fontsize='x-large', fontweight='bold')
    plt.savefig('Dan_vary_adversary_fraction_scaled' + str(N) + '_' + str(datetime.date.today()) + '_' + \
