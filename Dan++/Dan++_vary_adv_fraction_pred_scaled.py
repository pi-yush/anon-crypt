...
if __name__ == '__main__':
    ...
    ax2.set_xticklabels(ax2_labels, fontweight='bold', fontsize=11)
    ...
    plt.savefig('Dan++_vary_adversary_fraction_pred_scaled' + '_' + str(datetime.date.today()) + '_' + str(datetime.datetime.now().minute), dpi=600)
    #plt.show()
