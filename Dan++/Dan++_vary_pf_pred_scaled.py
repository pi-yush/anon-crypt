...
if __name__ == '__main__':
    ...
    #json.dump(all_entropy.copy(),open('Dan++_vary_pf' + str(N) + '_' + str(datetime.date.today()) + '_' + str(datetime.datetime.now().hour) + '.txt','w'))
    ...
    plt.savefig('Dan++_vary_pf' + '_' + str(datetime.date.today()) + '_' + str(datetime.datetime.now().minute), dpi=600)
    #plt.show()
